            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="contadorItems" href="${pageContext.request.contextPath}/Controlador?accion=Carrito"><i class="fas fa-cart-plus">(<label style="color: orange">${contador}</label>)</i> Carrito</a>
                        </li>
                    </ul>                
                    <ul class="navbar-nav">
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="card-footer text-center">
                                ...
                                <div>
                                    <!-- href="Controlador?accion=AgregarCarrito&id=${productos.id} -->
                                    <a class="btn btn-outline-info" onclick="enviarIdControlador(${productos.id})">Agregar a Carrito</a>
